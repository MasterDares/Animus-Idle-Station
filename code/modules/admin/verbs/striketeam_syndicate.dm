...
/mob/living/carbon/human/proc/equip_syndicate_commando(syndicate_leader_selected = 0)
	...
	equip_to_slot_or_qdel(new /obj/item/clothing/under/syndicate(src), slot_w_uniform)
	equip_to_slot_or_qdel(new /obj/item/clothing/shoes/swat(src), slot_shoes)
	if (!syndicate_leader_selected)
		equip_to_slot_or_qdel(new /obj/item/clothing/suit/space/syndicate/black(src), slot_wear_suit)
	else
		equip_to_slot_or_qdel(new /obj/item/clothing/suit/space/syndicate/black/red(src), slot_wear_suit)
	equip_to_slot_or_qdel(new /obj/item/clothing/gloves/swat(src), slot_gloves)
	if (!syndicate_leader_selected)
		equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/space/syndicate/black(src), slot_head)
	else
		equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/space/syndicate/black/red(src), slot_head)
	equip_to_slot_or_qdel(new /obj/item/clothing/mask/gas/syndicate(src), slot_wear_mask)
	...
	equip_to_slot_or_qdel(new /obj/item/ammo_magazine/c45(src), slot_in_backpack)
	equip_to_slot_or_qdel(new /obj/item/weapon/storage/firstaid/regular(src), slot_in_backpack)
	equip_to_slot_or_qdel(new /obj/item/weapon/plastique(src), slot_in_backpack)
	equip_to_slot_or_qdel(new /obj/item/device/flashlight(src), slot_in_backpack)
	if (!syndicate_leader_selected)
		equip_to_slot_or_qdel(new /obj/item/weapon/plastique(src), slot_in_backpack)
	else
		equip_to_slot_or_qdel(new /obj/item/weapon/pinpointer(src), slot_in_backpack)
		equip_to_slot_or_qdel(new /obj/item/weapon/disk/nuclear(src), slot_in_backpack)

	equip_to_slot_or_qdel(new /obj/item/weapon/melee/energy/sword(src), slot_l_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/grenade/empgrenade(src), slot_r_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/tank/emergency_oxygen(src), slot_s_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/gun/projectile/silenced(src), slot_belt)

	equip_to_slot_or_qdel(new /obj/item/weapon/gun/energy/pulse_rifle(src), slot_r_hand) //Will change to something different at a later time -- Superxpdude

...
/datum/admins/proc/quick_create_object(var/mob/user)
	...
	pathtext = input("Select the path of the object you wish to create.", "Path", "/obj") as null|anything in list("/obj","/obj/structure","/obj/item","/obj/effect","/obj/item/device","/obj/item/weapon","/obj/item/clothing","/obj/machinery","/obj/mecha")
	if(!pathtext)
		return

...
/proc/setupcorpses()
	for (var/obj/effect/landmark/A in landmarks_list)
		...
		if (A.name == "Corpse-Engineer")
			...
			M.real_name = "Corpse"
			M.death()
			M.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear)
			M.equip_to_slot_or_qdel(new /obj/item/device/pda/engineering(M), slot_belt)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/engineer(M), slot_w_uniform)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/orange(M), slot_shoes)
		//	M.equip_to_slot_or_qdel(new /obj/item/weapon/storage/toolbox/mechanical(M), slot_l_hand)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/yellow(M), slot_gloves)
			M.equip_to_slot_or_qdel(new /obj/item/device/t_scanner(M), slot_r_store)
			...
			if (prob(50))
				M.equip_to_slot_or_qdel(new /obj/item/clothing/mask/gas(M), slot_wear_mask)
			if (prob(50))
				M.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/hardhat(M), slot_head)
			else
				if (prob(50))
					M.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/welding(M), slot_head)
			qdel(A)
			continue
		if (A.name == "Corpse-Engineer-Space")
			...
			M.death()
			M.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear)
			M.equip_to_slot_or_qdel(new /obj/item/weapon/tank/emergency_oxygen(M), slot_belt)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/engineer(M), slot_w_uniform)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/orange(M), slot_shoes)
		...
		if (A.name == "Corpse-Engineer-Chief")
			...
			M.death()
			M.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear)
			M.equip_to_slot_or_qdel(new /obj/item/weapon/storage/utilitybelt(M), slot_belt)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/chief_engineer(M), slot_w_uniform)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/orange(M), slot_shoes)
		//	M.equip_to_slot_or_qdel(new /obj/item/weapon/storage/toolbox/mechanical(M), slot_l_hand)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/yellow(M), slot_gloves)
			M.equip_to_slot_or_qdel(new /obj/item/device/t_scanner(M), slot_r_store)
		...
		if (A.name == "Corpse-Syndicate")
			...
			M.death()
			M.equip_to_slot_or_qdel(new /obj/item/device/radio/headset(M), slot_l_ear)
			//M.equip_to_slot_or_qdel(new /obj/item/weapon/gun/revolver(M), slot_belt)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/under/syndicate(M), slot_w_uniform)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/black(M), slot_shoes)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/swat(M), slot_gloves)
			M.equip_to_slot_or_qdel(new /obj/item/weapon/tank/jetpack(M), slot_back)
			M.equip_to_slot_or_qdel(new /obj/item/clothing/mask/gas(M), slot_wear_mask)
			if (prob(50))
				M.equip_to_slot_or_qdel(new /obj/item/clothing/suit/space/syndicate(M), slot_wear_suit)
				if (prob(50))
					M.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/swat(M), slot_head)
				else
					M.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/space/syndicate(M), slot_head)
			else
